            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('/admin/customer/'.$customer->ID.'/active')}}" class="btn btn-success">Active</a>
                        @else
                        <a href="{{url('/admin/customer/'.$customer->ID.'/inactive')}}" class="btn btn-warning">Disable</a>

                        @endif
                    </td>
                    <td>
                        <a class="mx-1" title="view" ​​ data-toggle="modal" data-target="#bd-example-modal-lg-{{$customer->ID}}" type="button"><img src="{{url('asset/view.svg')}}" alt="" width="30"></a>
                    </td>
                </tr>
                <!-- View Customer Modal -->
