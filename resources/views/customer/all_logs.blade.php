...
<div class="page-header">
    <div class="row">
        <div class="col-12">
            <form id="joiningDateSearch" action="{{url('/export/logs/daterange')}}" method="POST">
            @csrf
                <div class="row">
...
<div class="card-box mb-30">
    ...
    <div class="p-2">
        ...
        <table class="table table-bordered table-striped hover multiple-select-row nowrap" id="customer">
            <thead>
                <tr>
                    <th>Handler</th>
                    <th>Cust Name</th>
                                            ...
                                            <div class="pd-20">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="EN_NAME" value="{{$log->CREATE_BY}}" required disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-6">
