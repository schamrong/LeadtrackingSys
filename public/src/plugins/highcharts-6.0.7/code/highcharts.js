...
(function (S, K) {
    ...
    (function (a) {
        ...
        a.error = function (q, f) {
            q = a.isNumber(q)
                ? "Highcharts error #" + q + ": www.highcharts.com/errors/" + q
                : q;
            if (f) throw Error(q);
        ...
        a.numberFormat = function (q, f, l, t) {
            ...
            -1 === f
                ...
                ? f &&
                  ...
                  ((u = f + +b[1]),
                  0 <= u
                      ? ((b[0] = (+b[0]).toExponential(u).split("e")[0]),
                        (f = u))
                      : ((b[0] = b[0].split(".")[0] || 0),
                        (q =
                            20 > f
                                ? (b[0] * Math.pow(10, b[1])).toFixed(f)
                                : 0),
                        (b[1] = 0)))
                : (f = 2);
            c = (
                Math.abs(b[1] ? b[0] : q) + Math.pow(10, -Math.max(f, v) - 1)
            ).toFixed(f);
            v = String(a.pInt(c));
        ...
        a.getStyle = function (q, f, l) {
            ...
            if ((q = E.getComputedStyle(q, void 0)))
                (q = q.getPropertyValue(f)),
                    a.pick(l, "opacity" !== f) && (q = a.pInt(q));
            return q;
        };
        ...
        a.map = function (a, f) {
            for (var l = [], t = 0, n = a.length; t < n; t++)
                l[t] = f.call(a[t], a[t], t, a);
            return l;
        };
        a.keys = function (q) {
        ...
        a.offset = function (a) {
            ...
            return {
                top:
                    a.top + (E.pageYOffset || f.scrollTop) - (f.clientTop || 0),
                left:
                    a.left +
                    (E.pageXOffset || f.scrollLeft) -
                    (f.clientLeft || 0),
            };
        };
        a.stop = function (q, f) {
        ...
        a.animate = function (q, f, l) {
            ...
            a.isObject(l) ||
                ((c = arguments),
                (l = { duration: c[2], easing: c[3], complete: c[4] }));
            ...
            a.objectEach(f, function (c, m) {
                ...
                v = null;
                "d" === m
                    ? ((u.paths = u.initPath(q, q.d, f.d)),
                      (u.toD = f.d),
                      (t = 0),
                      (v = 1))
                    : q.attr
                    ? (t = q.attr(m))
                    : ((t = parseFloat(a.getStyle(q, m)) || 0),
                      "opacity" !== m && (n = "px"));
                v || (v = c);
        ...
        E.jQuery &&
            (E.jQuery.fn.highcharts = function () {
                ...
                if (this[0])
                    return q[0]
                        ? (new a[a.isString(q[0]) ? q.shift() : "Chart"](
                              this[0],
                              q[0],
                              q[1]
                          ),
    ...
    (function (a) {
        ...
        a.Color.prototype = {
            ...
            init: function (l) {
                ...
                if (
                    (this.input = l =
                        this.names[l && l.toLowerCase ? l.toLowerCase() : ""] ||
                        l) &&
                    l.stops
                )
    ...
    (function (a) {
        ...
        h(B.prototype, {
            ...
            init: function (a, g) {
                this.element =
                    "span" === g ? v(g) : m.createElementNS(this.SVG_NS, g);
                this.renderer = a;
            },
            ...
            attr: function (a, g, c, w) {
                ...
                "string" === typeof a &&
                    ...
                    ((y = a), (a = {}), (a[y] = g));
                "string" === typeof a
                    ? (e = (this[a + "Getter"] || this._defaultGetter).call(
                          this,
                          a,
                          h
                      ))
            ...
            getBBox: function (a, g) {
                ...
                if (!y) {
                    ...
                    w.isSVG &&
                        ...
                        g &&
                            ((y.width =
                                Math.abs(w * Math.sin(b)) +
                                Math.abs(a * Math.cos(b))),
                            (y.height =
                                Math.abs(w * Math.cos(b)) +
            ...
            fillSetter: function (a, g, c) {
                "string" === typeof a
                    ? c.setAttribute(g, a)
                    : a && this.colorGradient(a, g, c);
            },
            visibilitySetter: function (a, g, c) {
                "inherit" === a
                    ? c.removeAttribute(g)
                    : this[g] !== a && c.setAttribute(g, a);
                this[g] = a;
            },
        ...
        h(H.prototype, {
            ...
            init: function (a, g, c, w, h, e) {
                ...
                this.createElement("desc")
                    .add()
                    .element.appendChild(
                        m.createTextNode("Created with Highcharts 6.0.7")
                    );
            ...
            buildText: function (a) {
                var c = a.element,
                    ...
                    R = function (a) {
                        ...
                        return l
                            ? g(l)
                            : w.fontMetrics(h, a.getAttribute("style") ? a : c)
                                  .h;
                    },
                    q = function (a, g) {
                ...
                w ||
                    (a.xSetter = function (a, g, c) {
                        ...
                        for (d = 0; d < w.length; d++)
                            (b = w[d]),
                                b.getAttribute(g) === h && b.setAttribute(g, a);
                        c.setAttribute(g, a);
                    });
                return a;
            },
            ...
            label: function (g, c, b, e, k, p, x, N, m) {
                ...
                q = function () {
                    ...
                    I &&
                        (L ||
                            ((r.box = L =
                                A.symbols[e] || t ? A.symbol(e) : A.rect()),
                            L.addClass(
    ...
    (function (a) {
        ...
        l(a.SVGElement.prototype, {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        F !== this.cTT &&
                            ...
                            q(n) &&
                                ...
                                this.setSpanRotation(n, l, C),
                            this.getSpanCorrection(
                                this.textPxLength || b.offsetWidth,
                                C,
                                l,
                                n,
                                z
            ...
            setSpanRotation: function (a, c, b) {
                ...
                d[e + (t ? "Origin" : "-origin")] = d.transformOrigin =
                    100 * c + "% " + b + "px";
                E(this.element, d);
            },
            ...
            dateFormat: function (l, f, u) {
                ...
                a.objectEach(b, function (a, b) {
                    for (; -1 !== l.indexOf("%" + b); )
                        l = l.replace(
                            "%" + b,
                            "function" === typeof a ? a.call(c, f) : a
                        );
                });
            ...
            getTimeTicks: function (a, v, u, c) {
                ...
                if (B(v)) {
                    b.set(
                        ...
                        e >= l.second
                            ? 0
                            : p * Math.floor(b.get("Milliseconds", k) / p)
                    );
                    e >= l.second &&
                        b.set(
                            "Seconds",
                            ...
                            e >= l.minute
                                ? 0
                                : p * Math.floor(b.get("Seconds", k) / p)
                        );
                    e >= l.minute &&
                        b.set(
                            "Minutes",
                            ...
                            e >= l.hour
                                ? 0
                                : p * Math.floor(b.get("Minutes", k) / p)
                        );
                    e >= l.hour &&
                        b.set(
                            "Hours",
                    ...
                    e === l.week &&
                        b.set(
                            "Date",
                            k,
                            b.get("Date", k) - b.get("Day", k) + f(c, 1)
                        );
                    h = b.get("FullYear", k);
                    c = b.get("Month", k);
                    var n = b.get("Date", k),
    ...
    (function (a) {
        ...
        a.setOptions = function (B) {
            ...
            a.time.update(
                H(a.defaultOptions.global, a.defaultOptions.time),
                !1
            );
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                a.isDatetimeAxis &&
                    h &&
                    (p =
                        v.dateTimeLabelFormats[h.higherRanks[m] || h.unitName]);
                this.isFirst = k;
                this.isLast = e;
            ...
            handleOverflow: function (a) {
                var f = this.axis,
                    ...
                    m = l(
                        f.labelRight,
                        Math.max(f.isRadial ? 0 : f.pos + f.len, b - m[1])
                    ),
                    h = this.label,
                    k = this.rotation,
            ...
            getPosition: function (l, f, u, c) {
                ...
                return {
                    x: l
                        ? a.correctFloat(
                              b.translate(f + u, null, null, c) + b.transB
                          )
                        : b.left +
                          b.offset +
                          (b.opposite
                              ? ((c && m.oldChartWidth) || m.chartWidth) -
                                b.right -
                                b.left
                              : 0),
                    y: l
                        ...
                        : a.correctFloat(
                              d - b.translate(f + u, null, null, c) - b.transB
                          ),
                };
            },
                ...
                H(z) ||
                    (z =
                        0 === k.side
                            ...
                            : 2 === k.side
                            ? n.y + 8
                            : Math.cos(f.rotation * t) *
                              (n.y - f.getBBox(!1, 0).height / 2));
                ...
                m ||
                    ...
                    (this.gridLine = m =
                        p
                            ...
                            .attr(d)
                            .addClass(
                                "highcharts-" + (k ? k + "-" : "") + "grid-line"
                            )
                            .add(c.gridGroup)));
                if (
                    !a &&
                    m &&
                    (a = c.getPlotLinePath(h + e, m.strokeWidth() * f, a, !0))
                )
        ...
        a.extend(G.prototype, {
            ...
            init: function (a, c) {
                ...
                var w = this.options,
                    d = w.type;
                b.labelFormatter =
                    w.labels.formatter || b.defaultLabelFormatter;
                b.userOptions = c;
                b.minPixelPadding = 0;
                ...
                b.crosshair = C(
                    w.crosshair,
                    F(a.options.tooltip.crosshairs)[g ? 0 : 1],
                    !1
                );
                c = b.options.events;
                -1 === e(b, a.axes) &&
            ...
            getPlotLinePath: function (a, c, b, d, e) {
                ...
                var A = function (a, g, c) {
                    if (a < g || a > c)
                        d ? (a = Math.min(Math.max(g, a), c)) : (N = !0);
                    return a;
                };
                ...
                r(e)
                    ? this.horiz
                        ? ((k = h),
                          (p = x - this.bottom),
                          (a = b = A(a, w, w + this.width)))
                        : ((a = w),
                          (b = m - this.right),
                          (k = p = A(k, h, h + this.height)))
                    : ((N = !0), (d = !1));
                return N && !d
                    ? null
                    : g.renderer.crispLine(["M", a, k, "L", b, p], c || 1);
            },
                    ...
                    if (a.isLog)
                        c(this.paddedTicks, function (g, c, b) {
                            c &&
                                h.push.apply(
                                    h,
                                    a.getLogTickPositions(e, b[c - 1], b[c], !0)
                                );
                        });
                    else if (
                        a.isDatetimeAxis &&
            ...
            nameToX: function (a) {
                ...
                void 0 !== d &&
                    ((this.names[d] = a.name), (this.names.keys[a.name] = d));
                return d;
            },
            ...
            setAxisTranslation: function (a) {
                ...
                g.translationSlope =
                    g.transA =
                    r =
                        g.options.staticScale || g.len / (b + k || 1);
            ...
            setTickInterval: function (g) {
                ...
                b.range &&
                    ...
                    ((b.userMin =
                        b.min =
                        I =
                            Math.max(b.dataMin, b.minFromRange())),
                    (b.userMax = B = b.max),
                    (b.range = null));
                m(b, "foundExtremes");
                ...
                r(e.softMin) &&
                    !r(b.userMin) &&
                    (b.min = Math.min(b.min, e.softMin));
                r(e.softMax) &&
                    !r(b.userMax) &&
                    (b.max = Math.max(b.max, e.softMax));
                ...
                b.tickInterval =
                    b.min === b.max || void 0 === b.min || void 0 === b.max
                        ...
                        : F &&
                          !D &&
                          J === b.linkedParent.options.tickPixelInterval
            ...
            tickSize: function (a) {
                ...
                if (g && c)
                    return "inside" === b[a + "Position"] && (c = -c), [c, g];
            },
            ...
            renderUnsquish: function () {
                ...
                c(d, function (a) {
                    (a = e[a]) &&
                        a.label &&
                        a.label.textPxLength > f &&
                        (f = a.label.textPxLength);
                });
            ...
            getOffset: function () {
                ...
                z &&
                    ...
                    A &&
                        !1 !== z.reserveSpace &&
                        ((a.titleOffset = F =
                            a.axisTitle.getBBox()[p ? "height" : "width"]),
                        (l = z.offset),
                ...
                G &&
                    (f =
                        f -
                        d +
                        t * (p ? C(J.y, a.tickRotCorr.y + 8 * t) : J.x));
            ...
            getTitlePosition: function () {
                var a = this.horiz,
                    ...
                    r = e.y || 0,
                    m = this.axisTitle,
                    A = this.chart.renderer.fontMetrics(
            ...
            destroy: function (a) {
                ...
                for (h in b.plotLinesAndBandsGroups)
                    b.plotLinesAndBandsGroups[h] =
                        b.plotLinesAndBandsGroups[h].destroy();
                D(b, function (a, c) {
            ...
            drawCrosshair: function (a, b) {
                ...
                this.crosshair && !1 !== (n(b) || !e)
                    ? (e
                          ? n(b) &&
                            (g = this.isXAxis ? b.plotX : this.len - b.plotY)
                          : (g =
                                a &&
                                (this.horiz
                                    ? a.chartX - this.pos
                      ...
                      n(c)
                          ? ((b = this.categories && !this.isRadial),
                            h ||
                                ...
                                d.dashStyle &&
                                    h.attr({ dashstyle: d.dashStyle })),
                            h.show().attr({ d: c }),
                            b &&
                                !d.width &&
                                h.attr({ "stroke-width": this.transA }),
                            (this.cross.e = a))
                          : this.hideCrosshair())
                    : this.hideCrosshair();
            },
    ...
    (function (a) {
        ...
        B.prototype.getLogTickPositions = function (a, t, n, v) {
            ...
            if (0.5 <= a)
                (a = Math.round(a)), (d = this.getLinearTickPositions(a, t, n));
            else if (0.08 <= a)
                for (
                    var c = Math.floor(t),
                        h,
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                l
                    ...
                    : r &&
                      (C && (D.fill = C),
                      m.borderWidth &&
                          ((D.stroke = m.borderColor),
                          (D["stroke-width"] = m.borderWidth)));
                A.zIndex = x;
                G += "-" + x;
            ...
            renderLabel: function (a, c, b, m) {
                ...
                d ||
                    ...
                    (d.zIndex = m),
                    (this.label = d =
                        h.text(a.text, 0, 0, a.useHTML).attr(d).add()),
                    d.css(a.style));
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function (a, b, m) {
                var c = this.chart,
                    ...
                    l =
                        !this.followPointer &&
                        t(m.ttBelow, !c.inverted === !!m.negative),
                    n = function (a, b, c, d, g, p) {
                        ...
                        if (l && r) k[a] = d;
                            ...
                            k[a] = Math.min(p - c, 0 > m - e ? m : m - e);
                        else if (r)
                            k[a] = Math.max(g, d + e + c > b ? d : d + e);
                        else return !1;
                    },
                    D = function (a, b, c, d) {
                        var e;
            ...
            refresh: function (a, b) {
                ...
                d.enabled &&
                    (clearTimeout(this.hideTimer),
                    (this.followPointer =
                        n(k)[0].series.tooltipOptions.followPointer),
                ...
                B(c.slice(0, b.length + 1), function (a, c) {
                    if (!1 !== a) {
                        ...
                        var l = c.series || m,
                            ...
                            F =
                                "highcharts-color-" +
                                t(c.colorIndex, x.colorIndex, "none");
                        z ||
                            (l.tt = z =
                                k
                                    .label(
                        ...
                        c.isHeader
                            ? ((r = a.height),
                              (x = Math.max(
                                  0,
                                  Math.min(
                                      c.plotX + h.plotLeft - x / 2,
                                      h.chartWidth - x
                                  )
                              )))
                            : (x =
                                  c.plotX + h.plotLeft - t(p.distance, 16) - x);
                        0 > x && (e = !1);
                        a =
                ...
                B(d, function (a) {
                    ...
                    a.tt.attr({
                        ...
                        x:
                            e || b.isHeader
                                ? a.x
                                : b.plotX + h.plotLeft + t(p.distance, 16),
                        y: a.pos + h.plotTop,
                        anchorX: b.isHeader
                            ? b.plotX + h.plotLeft
                            : b.plotX + c.xAxis.pos,
            ...
            getDateFormat: function (a, b, m, d) {
                ...
                for (p in u) {
                    ...
                    if (
                        r[p] &&
                        k.substr(r[p]) !== "01-01 00:00:00.000".substr(r[p])
                    )
                        break;
                    "week" !== p && (f = p);
                }
            ...
            getXDateFormat: function (a, b, m) {
                ...
                return (
                    (c
                        ? this.getDateFormat(c, a.x, m.options.startOfWeek, b)
                        : b.day) || b.year
                );
            },
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            ...
            setDOMEvents: function () {
                ...
                this.unbindContainerMouseLeave = B(
                    c,
                    "mouseleave",
    ...
    (function (a) {
        ...
        E(a.Pointer.prototype, {
            pinchTranslate: function (a, f, l, q, c, b) {
                this.zoomHor &&
                    this.pinchTranslateDirection(!0, a, f, l, q, c, b);
                this.zoomVert &&
                    this.pinchTranslateDirection(!1, a, f, l, q, c, b);
            },
            ...
            pinch: function (a) {
                var n = this,
                    ...
                    e =
                        1 === b &&
                        ((n.inClass(a.target, "highcharts-tracker") &&
                            t.runTrackerClick) ||
                            n.runChartClick),
                    p = {};
                1 < b && (n.initiated = !0);
            ...
            f(t.prototype, {
                ...
                onContainerPointerMove: function (a) {
                    d(a, "onContainerTouchMove", "touchmove", function (a) {
                        ...
                        c[a.pointerId].target ||
                            (c[a.pointerId].target = a.currentTarget);
                    });
                },
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function (a, b) {
                ...
                f &&
                    (n &&
                        f.isMarker &&
                        ((D = a.pointAttribs()), b || (D.stroke = D.fill = m)),
                    f.attr(D));
            },
            ...
            renderItem: function (a) {
                ...
                z.width ||
                    G.css({
                        width:
                            (d.itemWidth || d.width || b.spacingBox.width) - t,
                    });
                this.setText(a);
                c = G.getBBox();
                z = a.checkboxOffset =
                    d.itemWidth || a.legendItemWidth || c.width + t;
                this.itemHeight = c = Math.round(
                    a.legendItemHeight || c.height || this.symbolHeight
                );
                f &&
                    this.itemX - D + z >
                        (F || b.spacingBox.width - 2 * D - d.x) &&
                    ((this.itemX = D),
                ...
                f
                    ? (this.itemX += z)
                    : ((this.itemY += J + c + A), (this.lastLineHeight = c));
                this.offsetWidth =
                    F ||
                    Math.max(
                        (f ? this.itemX - D - (a.checkbox ? 0 : C) : z) + D,
                        this.offsetWidth
                    );
            },
            ...
            render: function () {
                ...
                l &&
                    ...
                    /(lth|ct|rth)/.test(a.getAlignment()) &&
                        (k = n(k, {
                            y: k.y + b.titleOffset + b.options.title.margin,
                        })),
            ...
            handleOverflow: function (a) {
                ...
                a > c && !1 !== D.enabled
                    ? ((this.clipHeight = z =
                          Math.max(c - 20 - this.titleHeight - n, 0)),
                      ...
                      q ||
                          ((q = b.clipRect = d.clipRect(0, n, 9999, 0)),
        ...
        d(P.prototype, {
            ...
            init: function (b, c) {
                ...
                for (d in g.plotOptions)
                    g.plotOptions[d].tooltip =
                        (h[d] && D(h[d].tooltip)) || void 0;
            ...
            redraw: function (b) {
                ...
                for (b = g.length; b--; )
                    if (
                        ((F = g[b]),
                        F.options.stacking && ((x = !0), F.isDirty))
                    ) {
                        l = !0;
                        break;
                    }
                if (l)
                    for (b = g.length; b--; )
                        (F = g[b]), F.options.stacking && (F.isDirty = !0);
                m(g, function (a) {
                    a.isDirty &&
            ...
            getMargins: function (a) {
                ...
                d &&
                    ...
                    (this.plotTop = Math.max(
                        this.plotTop,
                        d + this.options.title.margin + c[0]
                    ));
                this.legend &&
                    this.legend.display &&
                    this.legend.adjustMargins(g, c);
                this.extraMargin &&
            ...
            setChartSize: function (a) {
                ...
                this.plotHeight = p = Math.max(
                    0,
                    Math.round(d - x - this.marginBottom)
                );
                ...
                this.clipBox = {
                    ...
                    y: c,
                    width: Math.floor(
                        this.plotSizeX - Math.max(g, k[1]) / 2 - b
                    ),
                    height: Math.max(
                        0,
            ...
            drawChartBox: function () {
                ...
                m = { fill: m || "none" };
                if (f || d["stroke-width"])
                    (m.stroke = a.borderColor), (m["stroke-width"] = f);
                ...
                p &&
                    (x
                        ? x.animate(z)
                        : (this.plotBGImage = b.image(p, F, n, w, r).add()));
                G
    ...
    (function (a) {
        ...
        a.Point.prototype = {
            ...
            applyOptions: function (a, b) {
                ...
                void 0 === this.x &&
                    c &&
                    (this.x = void 0 === b ? c.autoIncrement(this) : b);
                return this;
            },
            ...
            },
            {
                ...
                getCyclic: function (a, b, c) {
                    var d,
                        ...
                        f = c
                            ? c.length
                            : r(e.options.chart[a + "Count"], e[a + "Count"]);
                    b ||
                        ((d = r(g[h], g["_" + h])),
                        n(d) ||
                ...
                getExtremes: function (a) {
                    ...
                    for (n = 0; n < e; n++)
                        if (
                            ...
                            (l =
                                (h(x, !0) || d(x)) &&
                                (!b.positiveValuesOnly || x.length || 0 < x)),
                            (p =
                ...
                translate: function () {
                    ...
                    for (a = 0; a < m; a++) {
                        ...
                        I.yBottom = n(C)
                            ? Math.min(
                                  Math.max(-1e5, k.translate(C, 0, 1, 0, 1)),
                                  1e5
                              )
                            : null;
                        ...
                        I.isNull ||
                            (void 0 !== v && (M = Math.min(M, Math.abs(t - v))),
                            (v = t));
                            ...
                            (e = a[c]),
                                ...
                                d && !e.isNull
                                    ? ((d = r(k.symbol, this.symbol)),
                                      (p = this.markerAttribs(
                                          e,
                                          e.selected && "select"
                                      )),
                                      g
                                          ? g[m ? "show" : "hide"](!0).animate(
                                                p
                                            )
                                          : m &&
                ...
                destroy: function () {
                    ...
                    for (h = g.length; h--; )
                        (k = g[h]) && k.destroy && k.destroy();
                    a.points = null;
                    clearTimeout(a.animationTimeout);
                    p(a, function (a, b) {
                        a instanceof M &&
                            !a.survive &&
                            ((d = e && "group" === b ? "hide" : "destroy"),
                            a[d]());
                    });
    ...
    (function (a) {
        ...
        a.StackItem = function (a, b, f, d, h) {
            ...
            this.alignOptions = {
                ...
                verticalAlign:
                    b.verticalAlign || (c ? "middle" : f ? "bottom" : "top"),
                y: v(b.y, c ? 4 : f ? 14 : -6),
                x: v(b.x, c ? (f ? -6 : 6) : 0),
            };
            this.textAlign =
                b.textAlign || (c ? (f ? "right" : "left") : "center");
        };
            ...
            setOffset: function (a, b) {
                ...
                if ((b = this.label))
                    b.align(this.alignOptions, null, h),
                        (h = b.alignAttr),
                        b[
                            !1 === this.options.crop || d.isInsidePlot(h.x, h.y)
                                ? "show"
                                : "hide"
                        ](!0);
            },
            ...
            if (
                ...
                for (G = 0; G < d; G++)
                    (g = c[G]),
                        ...
                        (A = D[A][g]),
                        null !== w
                            ? ((A.points[J] = A.points[this.index] =
                                  [v(A.cumulative, e)]),
    ...
    (function (a) {
            ...
            update: function (a, d, f) {
                ...
                if (n) {
                    ...
                    if ("inverted" in n || "polar" in n)
                        p.propFromSeries(), (r = !0);
                    "alignTicks" in n && (r = !0);
                    k(n, function (a, b) {
                        -1 !== c("chart." + b, p.propsRequireUpdateSeries) &&
                            (g = !0);
                ...
                k(a, function (a, b) {
                    ...
                    "chart" !== b &&
                        -1 !== c(b, p.propsRequireUpdateSeries) &&
                        (g = !0);
                });
                t(
        ...
        v(r.prototype, {
            addPoint: function (a, b, c, d) {
                ...
                z = l.x;
                r = n.length;
                if (this.requireSorting && z < n[r - 1])
                    for (m = !0; r && n[r - 1] > z; ) r--;
        ...
        v(E.prototype, {
            update: function (a, b) {
                var c = this.chart;
                a = c.options[this.coll][this.options.index] = h(
                    this.userOptions,
                    a
                );
                this.destroy(!0);
                ...
                getStackPoints: function (f) {
                    ...
                    if (this.options.stacking) {
                        for (r = 0; r < f.length; r++)
                            (f[r].leftNull = f[r].rightNull = null),
                                (m[f[r].x] = f[r]);
                        a.objectEach(b, function (a, b) {
                ...
                drawGraph: function () {
                    ...
                    H(u, function (c) {
                        var b = c[0],
                            f = a[b];
                        f
                            ? ((f.endX = a.preventGraphAnimation
                                  ? null
                                  : l.xMap),
                              f.animate({ d: l }))
                            : ((f = a[b] =
                ...
                getPointSpline: function (a, E, q) {
                    ...
                    if (
                        ...
                        v > a && v > l
                            ...
                            : v < a &&
                              v < l &&
                              ((v = Math.min(a, l)), (c = 2 * l - v));
                        c > q && c > l
                            ? ((c = Math.max(q, l)), (v = 2 * l - c))
                            : c < q &&
                              c < l &&
                              ((c = Math.min(q, l)), (v = 2 * l - c));
                        E.rightContX = u;
                        E.rightContY = c;
                    }
                    E = [
            ...
            },
            {
                    ...
                    E(a.points, function (c) {
                        ...
                        l &&
                            ...
                            c.y === k &&
                                ...
                                (r = !r),
                            (n =
                                Math.abs(n - e) > l ? d - l : e - (r ? l : 0)));
                        c.barX = p;
                        c.pointWidth = q;
                        c.tooltipPos = b.inverted
                            ? [
                                  h.len + h.pos - b.plotLeft - f,
                                  a.xAxis.len - p - m / 2,
                                  g,
                              ]
                ...
                pointAttribs: function (a, b) {
                    ...
                    a &&
                        this.zones.length &&
                        ((e = a.getZone()),
                        (e = a.options.color || (e && e.color) || this.color));
                    b &&
                        ((a = l(
                            c.states[b],
                ...
                drawPoints: function () {
                    ...
                    E(a.points, function (c) {
                        ...
                        if (f(c.plotY) && null !== c.y) {
                            k = c.shapeArgs;
                            if (e)
                                e[b.pointCount < h ? "animate" : "attr"](l(k));
                            else
                                c.graphic = e = d[c.shapeType](k).add(
                                    c.group || a.group
                                );
                            m.borderRadius && e.attr({ r: m.borderRadius });
                            e.attr(
                                a.pointAttribs(c, c.selected && "select")
                            ).shadow(
                                m.shadow,
                                null,
        ...
        b(
            ...
            },
            {
                ...
                updateTotals: function () {
                    ...
                    for (a = 0; a < e; a++)
                        (f = c[a]),
                            (b += l && !f.visible ? 0 : f.isNull ? 0 : f.y);
                    this.total = b;
                    for (a = 0; a < e; a++)
                        (f = c[a]),
                            (f.percentage =
                ...
                translate: function (a) {
                    ...
                    this.getX = function (b, c, e) {
                        ...
                        return (
                            ...
                            (c ? -1 : 1) *
                                Math.cos(n) *
                                (a[2] / 2 + e.labelDistance)
                        );
                    };
                    for (A = 0; A < B; A++) {
                        G = u[A];
                        G.labelDistance = v(
                            G.options.dataLabels &&
                                G.options.dataLabels.distance,
                            F
                        );
    ...
    (function (a) {
            ...
            for (
                ...
                for (h = !1; f--; )
                    0 < f &&
                        ...
                        ((a[f - 1].size += a[f].size),
                        (a[f - 1].targets = a[f - 1].targets.concat(
                            a[f].targets
                        )),
                        (a[f - 1].align = 0.5),
                        a[f - 1].pos + a[f - 1].size > b &&
                            (a[f - 1].pos = b - a[f - 1].size),
                        a.splice(f, 1),
                        (h = !0));
            }
            f = 0;
                ...
                c.dlProcessOptions && c.dlProcessOptions(f),
                    ...
                    q(m, function (h) {
                        ...
                        k &&
                            ...
                            "contrast" === v.color &&
                                ((h.contrastColor = A.getContrast(
                                    h.color || c.color
                                )),
                                (v.color =
                                    f.inside ||
                                    0 > u(h.labelDistance, f.distance) ||
                                    d.stacking
                                        ? h.contrastColor
                                        : "#000000")),
                        ...
                        !g || (k && E(C))
                            ...
                            : ((h.dataLabel = g = g.destroy()),
                              q && (h.connector = q.destroy()));
                    });
        ...
        b.prototype.justifyDataLabel = function (a, b, c, d, f, l) {
            ...
            m = c.x + p;
            0 > m &&
                ("right" === h ? (b.align = "left") : (b.x = -m), (n = !0));
            m = c.x + d.width - p;
            m > e.plotWidth &&
                ("left" === h ? (b.align = "right") : (b.x = e.plotWidth - m),
                (n = !0));
            m = c.y + p;
            0 > m &&
                ("bottom" === k ? (b.verticalAlign = "top") : (b.y = -m),
                (n = !0));
            m = c.y + d.height - p;
            m > e.plotHeight &&
                ("top" === k
        ...
        m.pie &&
                        ...
                        if (n)
                            for (
                                ...
                                (e = b[K]),
                                    ...
                                    (P = l.justify
                                        ? x[0] +
                                          (d ? -1 : 1) * (F + e.labelDistance)
                                        : c.getX(
                                              N < e.top + 2 || N > e.bottom - 2
                                                  ? h
                                                  : N,
                                              d,
                                              e
            ...
            (m.pie.prototype.verifyDataLabelOverflow = function (a) {
                ...
                l ||
                    ...
                    null !== d[1]
                        ? (h = Math.max(
                              Math.min(h, b[2] - Math.max(a[0], a[2])),
                              f
                          ))
        ...
        m.column &&
            (m.column.prototype.alignDataLabel = function (a, c, d, f, l) {
                var e = this.chart.inverted,
                    ...
                    m = u(
                        a.below,
                        a.plotY > u(this.translatedThreshold, h.yAxis.len)
                    ),
        ...
        I = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (t(a.trackerGroups, function (d) {
                        if (a[d]) {
                            ...
                            a.options.cursor &&
                                a[d].css(q).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function () {
                ...
                if (e && !c)
                    for (m = e + 1; m--; )
                        "M" === d[m] &&
                            d.splice(m + 1, 0, d[m + 1] - l, d[m + 2], "L"),
                            ((m && "M" === d[m]) || m === e) &&
                    ...
                    var d = b.horiz,
                        ...
                        m = Math.min(
                            ...
                            g
                                ? k.min
                                : b.toValue(
                                      b.toPixels(k.min) - b.minPixelPadding
                                  )
                        ),
                        g = Math.max(
                            k.dataMax,
                            g
                                ? k.max
                                : b.toValue(
                                      b.toPixels(k.max) + b.minPixelPadding
                                  )
                        ),
                        n = m - h;
                    0 < n && ((l += n), (h = m));
            ...
            setState: function (a, b) {
                ...
                if (
                    ...
                    if (this.graphic)
                        ...
                        q &&
                            (q[
                                a && t.isInsidePlot(c, d, t.inverted)
                                    ? "show"
                                    : "hide"
                            ](),
                    ...
                    (c = f.halo) && c.size
                        ? (u ||
                              (e.halo = u =
                                  t.renderer
                                      .path()
                                      .add((this.graphic || q).parentGroup)),
                          u.show()[b ? "animate" : "attr"]({
