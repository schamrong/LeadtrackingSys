...
class FilterReport implements FromCollection, ShouldAutoSize, WithCustomStartCell, WithDrawings, WithEvents, WithHeadings
{
    public $filter = '';
    public $logs = [];
    public function __construct($filter, $logs)
    {
        $this->filter = $filter;
        $this->logs = $logs;
    }
